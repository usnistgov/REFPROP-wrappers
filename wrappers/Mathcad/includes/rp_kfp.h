...
FUNCTIONINFO    rp_kfp =
{
    (char *)("rp_kfp"),                 // Name by which mathcad will recognize the function
    (char *)("fluid,t"),                // rp_kfp will be called as rp_kfp(fluid,t)
    (char *)("Returns the saturated liquid viscosity [W/m-s] given the saturation pressure [MPa]"),
                                        // description of rp_kfp(fluid,t)
    (LPCFUNCTION)rp_Kfp,                // pointer to the executable code
