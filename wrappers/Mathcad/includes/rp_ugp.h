...
FUNCTIONINFO    rp_ugp = 
{ 
    (char *)("rp_ugp"),                 // Name by which mathcad will recognize the function
    (char *)("fluid,p"),                // rp_ugp will be called as rp_ugp(fluid,p)
    (char *)("Returns the saturation vapor internal energy [kJ/kg] given the pressure [MPa]"),
                                        // description of rp_ugp(fluid,p)
    (LPCFUNCTION)rp_Ugp,                // pointer to the executable code
