...
FUNCTIONINFO    rp_sft = 
{ 
    (char *)("rp_sft"),                 // Name by which mathcad will recognize the function
    (char *)("fluid,t"),                // rp_sft will be called as rp_sft(fluid,t)
    (char *)("Returns the saturation liquid entropy [kJ/kg] given the temperature [K]"),
                                        // description of rp_sft(fluid,t)
    (LPCFUNCTION)rp_Sft,                // pointer to the executable code
