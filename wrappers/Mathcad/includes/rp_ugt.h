...
FUNCTIONINFO    rp_ugt = 
{ 
    (char *)("rp_ugt"),                          // Name by which mathcad will recognize the function
    (char *)("fluid,t"),                                // rp_ugt will be called as rp_ugt(fluid,t)
    (char *)("Returns the saturation vapor internal energy [kJ/kg] given the temperature [K]"),
										// description of rp_ugt(fluid,t)
    (LPCFUNCTION)rp_Ugt,               // pointer to the executable code
