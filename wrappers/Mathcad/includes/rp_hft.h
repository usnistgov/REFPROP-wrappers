...
FUNCTIONINFO    rp_hft = 
{ 
    (char *)("rp_hft"),                 // Name by which mathcad will recognize the function
    (char *)("fluid,t"),                // rp_hft will be called as rp_hft(fluid,t)
    (char *)("Returns the saturation liquid enthalpy [kJ/kg] given the temperature [K]"),
                                        // description of rp_hft(fluid,t)
    (LPCFUNCTION)rp_Hft,                // pointer to the executable code
