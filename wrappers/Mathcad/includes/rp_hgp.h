...
FUNCTIONINFO    rp_hgp = 
{ 
    (char *)("rp_hgp"),                 // Name by which mathcad will recognize the function
    (char *)("fluid,p"),                // rp_hgp will be called as rp_hgp(fluid,p)
    (char *)("Returns the saturation vapor enthalpy [kJ/kg] given the pressure [MPa]"),
										// description of rp_hgp(fluid,p)
    (LPCFUNCTION)rp_Hgp,                // pointer to the executable code
