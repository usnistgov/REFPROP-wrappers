...
FUNCTIONINFO    rp_cvgt = 
{ 
    (char *)("rp_cvgt"),                          // Name by which mathcad will recognize the function
    (char *)("fluid,t"),                                // rp_cvgt will be called as rp_cvgt(fluid,t)
    (char *)("Returns the saturated vapor isochoric specific heat [kJ/kg] given the temperature [K]"),
										// description of rp_cvgt(fluid,t)
    (LPCFUNCTION)rp_Cvgt,               // pointer to the executable code
