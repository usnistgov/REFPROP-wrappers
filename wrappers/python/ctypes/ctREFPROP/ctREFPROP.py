...
on 27 Feb 2018 14:14:27.  This interface was written by Ian Bell. 
...
def REFPROPFunctionLibrary(name, shared_extension):
    ...
    managed_handle = None # Not part of the manager, a standalone instance of REFPROP
...
class REFPROPInstance(object):
    ...
    def __init__(self, dll, managed_handle = None):
        ...
        managed_handle : int, optional
            The integer handle of the copy of REFPROP being managed
        """
        self.dll = dll
