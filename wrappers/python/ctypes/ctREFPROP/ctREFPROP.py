...
on 21 Sep 2017 16:27:50.  This interface was written by Ian Bell. 
...
class REFPROPFunctionLibrary():
    ...
    def __init__(self, name):
        ...
        self._ACTVYdlloutput_tuple = namedtuple('ACTVYdlloutput',["actv","gamm","ierr","herr"])
        self._AGdlloutput_tuple = namedtuple('AGdlloutput',["a","g"])
        self._ALLPROPSdlloutput_tuple = namedtuple('ALLPROPSdlloutput',["Output","hUnits","ierr","herr"])
        self._ALLPRP200dlloutput_tuple = namedtuple('ALLPRP200dlloutput',["Output","hUnits","ierr","herr"])
        ...
        self._GETMODdlloutput_tuple = namedtuple('GETMODdlloutput',["htype","hcode","hcite"])
        ...
        self._REFPROPdlloutput_tuple = namedtuple('REFPROPdlloutput',["Output","x","y","x3","q","ierr","herr"])
        ...
        self._SATTPdlloutput_tuple = namedtuple('SATTPdlloutput',["D","Dl","Dv","x","y","q","ierr","herr"])
    ...
    def ACTVYdll(self,T,D,z):
        ...
        return self._ACTVYdlloutput_tuple(list(actv),list(gamm),ierr.value,trim(herr.raw))
    ...
    def ALLPROPSdll(self,hab,T,D,z,iFlg,iFlg2):
        """
        Output,hUnits,ierr,herr = ALLPROPSdll(hab,T,D,z,iFlg,iFlg2)
        """
        ...
        self._ALLPROPSdll(hab,ct.byref(T),ct.byref(D),z,ct.byref(iFlg),ct.byref(iFlg2),Output,hUnits,ct.byref(ierr),herr,255,1000,255)

        return self._ALLPROPSdlloutput_tuple(list(Output),trim(hUnits.raw),ierr.value,trim(herr.raw))

    def ALLPRP200dll(self,hab,T,D,z,iFlg,iFlg2):
        """
        Output,hUnits,ierr,herr = ALLPRP200dll(hab,T,D,z,iFlg,iFlg2)
        """
        ...
        self._ALLPRP200dll(hab,ct.byref(T),ct.byref(D),z,ct.byref(iFlg),ct.byref(iFlg2),Output,hUnits,ct.byref(ierr),herr,10000,10000,255)

        return self._ALLPRP200dlloutput_tuple(list(Output),trim(hUnits.raw),ierr.value,trim(herr.raw))
    ...
    def GETMODdll(self,icomp):
        ...
        return self._GETMODdlloutput_tuple(trim(htype.raw),trim(hcode.raw),trim(hcite.raw))
    ...
    def REFPROPdll(self,hFld,hIn,hOut,hUnits,iFlag,iFlag2,a,b,z):
        """
        Output,x,y,x3,q,ierr,herr = REFPROPdll(hFld,hIn,hOut,hUnits,iFlag,iFlag2,a,b,z)
        """
        ...
        hUnits = ct.create_string_buffer(hUnits.encode('utf-8'),255)
        iFlag = ct.c_long(iFlag)
        iFlag2 = ct.c_long(iFlag2)
        a = ct.c_double(a)
        b = ct.c_double(b)
        z = (len(z)*ct.c_double)(*z)
        Output = (200*ct.c_double)()
        ...
        self._REFPROPdll(hFld,hIn,hOut,hUnits,ct.byref(iFlag),ct.byref(iFlag2),ct.byref(a),ct.byref(b),z,Output,x,y,x3,ct.byref(q),ct.byref(ierr),herr,10000,255,255,255,255)

        return self._REFPROPdlloutput_tuple(list(Output),list(x),list(y),list(x3),q.value,ierr.value,trim(herr.raw))
    ...
    def SATTPdll(self,T,P,z,iFlsh,iGuess):
        ...
        return self._SATTPdlloutput_tuple(D.value,Dl.value,Dv.value,list(x),list(y),q.value,ierr.value,trim(herr.raw))
