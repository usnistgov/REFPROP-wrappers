...
on 08 Aug 2017 10:11:21.  This interface was written by Ian Bell. 
...
class REFPROPFunctionLibrary():
    ...
    def ALLPROPSdll(self,hab,T,D,z,iFlg):
        """
        Output,hUnits,ierr,herr = ALLPROPSdll(hab,T,D,z,iFlg)
        """
    ...
    def ALLPRP200dll(self,hab,T,D,z,iFlg):
        """
        Output,hUnits,ierr,herr = ALLPRP200dll(hab,T,D,z,iFlg)
        """
