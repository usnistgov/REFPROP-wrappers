"""This file was auto-generated by the script 
    ...
    on 06 Aug 2017 18:44:28.  This interface was written by Ian Bell. 

    If you have any problems, please file an issue at https://github.com/usnistgov/REFPROP-wrappers/issues/
    """
...
class REFPROPFunctionLibrary():
    ...
    def __init__(self, name):
        ...
        self._ACTVYdll = self._getfcn(self.dll, 'ACTVYdll')
        self._AGdll = self._getfcn(self.dll, 'AGdll')
        self._ALLPROPSdll = self._getfcn(self.dll, 'ALLPROPSdll')
        self._ALLPRP200dll = self._getfcn(self.dll, 'ALLPRP200dll')
    ...
    def ABFL1dll(self,a,b,z,kph,ab,Dmin,Dmax):
        ...
        return namedtuple('ABFL1dlloutput',["T","P","D","ierr","herr"])(T.value,P.value,D.value,ierr.value,trim(herr.raw))
    ...
    def ABFL2dll(self,a,b,z,kq,ksat,ab):
        ...
        return namedtuple('ABFL2dlloutput',["Tbub","Tdew","Pbub","Pdew","Dlbub","Dvdew","ybub","xdew","T","P","Dl","Dv","x","y","q","ierr","herr"])(Tbub.value,Tdew.value,Pbub.value,Pdew.value,Dlbub.value,Dvdew.value,list(ybub),list(xdew),T.value,P.value,Dl.value,Dv.value,list(x),list(y),q.value,ierr.value,trim(herr.raw))
    ...
    def ABFLSHdll(self,ab,a,b,z,iFlag):
        ...
        return namedtuple('ABFLSHdlloutput',["T","P","D","Dl","Dv","x","y","q","e","h","s","Cv","Cp","w","ierr","herr"])(T.value,P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))

    def ACTVYdll(self,T,D,z):
        """
        actv,gamm,ierr,herr = ACTVYdll(T,D,z)
        """
        T = ct.c_double(T)
        D = ct.c_double(D)
        z = (len(z)*ct.c_double)(*z)
        ...
        if self._ACTVYdll is None: raise ValueError("The function ACTVYdll could not be loaded from the shared library.") 
        self._ACTVYdll(ct.byref(T),ct.byref(D),z,actv,gamm,ct.byref(ierr),herr,255)

        return namedtuple('ACTVYdlloutput',["actv","gamm","ierr","herr"])(list(actv),list(gamm),ierr.value,trim(herr.raw))
    ...
    def AGdll(self,T,D,z):
        ...
        return namedtuple('AGdlloutput',["a","g"])(a.value,g.value)

    def ALLPROPSdll(self,hab,T,D,z,iFlg,hUnits):
        """
        Output,hUnits,ierr,herr = ALLPROPSdll(hab,T,D,z,iFlg,hUnits)
        """
        hab = ct.create_string_buffer(hab.encode('utf-8'),255)
        T = ct.c_double(T)
        D = ct.c_double(D)
        z = (len(z)*ct.c_double)(*z)
        iFlg = ct.c_long(iFlg)
        Output = (20*ct.c_double)()
        hUnits = ct.create_string_buffer(hUnits.encode('utf-8'),1000)
        ierr = ct.c_long()
        herr = ct.create_string_buffer(255)

        if self._ALLPROPSdll is None: raise ValueError("The function ALLPROPSdll could not be loaded from the shared library.") 
        self._ALLPROPSdll(hab,ct.byref(T),ct.byref(D),z,ct.byref(iFlg),Output,hUnits,ct.byref(ierr),herr,255,1000,255)

        return namedtuple('ALLPROPSdlloutput',["Output","hUnits","ierr","herr"])(list(Output),trim(hUnits.raw),ierr.value,trim(herr.raw))

    def ALLPRP200dll(self,hab,T,D,z,iFlg,hUnits):
        """
        Output,hUnits,ierr,herr = ALLPRP200dll(hab,T,D,z,iFlg,hUnits)
        """
        hab = ct.create_string_buffer(hab.encode('utf-8'),10000)
        T = ct.c_double(T)
        D = ct.c_double(D)
        z = (len(z)*ct.c_double)(*z)
        iFlg = ct.c_long(iFlg)
        Output = (200*ct.c_double)()
        hUnits = ct.create_string_buffer(hUnits.encode('utf-8'),10000)
        ierr = ct.c_long()
        herr = ct.create_string_buffer(255)

        if self._ALLPRP200dll is None: raise ValueError("The function ALLPRP200dll could not be loaded from the shared library.") 
        self._ALLPRP200dll(hab,ct.byref(T),ct.byref(D),z,ct.byref(iFlg),Output,hUnits,ct.byref(ierr),herr,10000,10000,255)

        return namedtuple('ALLPRP200dlloutput',["Output","hUnits","ierr","herr"])(list(Output),trim(hUnits.raw),ierr.value,trim(herr.raw))
    ...
    def B12dll(self,T,z):
        ...
        return namedtuple('B12dlloutput',["B"])(B.value)
    ...
    def BLCRVdll(self,D,z,T):
        ...
        return namedtuple('BLCRVdlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def CCRITdll(self,T,P,v,z):
        ...
        return namedtuple('CCRITdlloutput',["Cs","Ts","Ds","Ps","ws","ierr","herr"])(Cs.value,Ts.value,Ds.value,Ps.value,ws.value,ierr.value,trim(herr.raw))
    ...
    def CHEMPOTdll(self,T,D,z):
        ...
        return namedtuple('CHEMPOTdlloutput',["u","ierr","herr"])(list(u),ierr.value,trim(herr.raw))
    ...
    def CP0dll(self,T,z):
        ...
        return namedtuple('CP0dlloutput',["Cp"])(Cp.value)
    ...
    def CRITPdll(self,z):
        ...
        return namedtuple('CRITPdlloutput',["Tc","Pc","Dc","ierr","herr"])(Tc.value,Pc.value,Dc.value,ierr.value,trim(herr.raw))
    ...
    def CRTPNTdll(self,z,Tc,Pc):
        ...
        return namedtuple('CRTPNTdlloutput',["Tc","Pc","Dc","ierr","herr"])(Tc.value,Pc.value,Dc.value,ierr.value,trim(herr.raw))
    ...
    def CSATKdll(self,icomp,T,kph):
        ...
        return namedtuple('CSATKdlloutput',["P","D","Csat","ierr","herr"])(P.value,D.value,Csat.value,ierr.value,trim(herr.raw))
    ...
    def CSTARdll(self,T,P,v,z):
        ...
        return namedtuple('CSTARdlloutput',["Cs","Ts","Ds","Ps","ws","ierr","herr"])(Cs.value,Ts.value,Ds.value,Ps.value,ws.value,ierr.value,trim(herr.raw))
    ...
    def CV2PKdll(self,icomp,T,D):
        ...
        return namedtuple('CV2PKdlloutput',["Cv2p","Csat","ierr","herr"])(Cv2p.value,Csat.value,ierr.value,trim(herr.raw))
    ...
    def CVCPKdll(self,icomp,T,D):
        ...
        return namedtuple('CVCPKdlloutput',["Cv","Cp"])(Cv.value,Cp.value)
    ...
    def CVCPdll(self,T,D,z):
        ...
        return namedtuple('CVCPdlloutput',["Cv","Cp"])(Cv.value,Cp.value)
    ...
    def DBDTdll(self,T,z):
        ...
        return namedtuple('DBDTdlloutput',["dBT"])(dBT.value)
    ...
    def DBFL1dll(self,D,b,z,hab):
        ...
        return namedtuple('DBFL1dlloutput',["T","P","ierr","herr"])(T.value,P.value,ierr.value,trim(herr.raw))
    ...
    def DBFL2dll(self,D,b,z,kq,ab):
        ...
        return namedtuple('DBFL2dlloutput',["T","P","Dl","Dv","x","y","q","ierr","herr"])(T.value,P.value,Dl.value,Dv.value,list(x),list(y),q.value,ierr.value,trim(herr.raw))
    ...
    def DDDPdll(self,T,D,z):
        ...
        return namedtuple('DDDPdlloutput',["dDdP"])(dDdP.value)
    ...
    def DDDTdll(self,T,D,z):
        ...
        return namedtuple('DDDTdlloutput',["dDdT"])(dDdT.value)
    ...
    def DEFL1dll(self,D,e,z):
        ...
        return namedtuple('DEFL1dlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def DEFLSHdll(self,D,e,z):
        ...
        return namedtuple('DEFLSHdlloutput',["T","P","Dl","Dv","x","y","q","h","s","Cv","Cp","w","ierr","herr"])(T.value,P.value,Dl.value,Dv.value,list(x),list(y),q.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def DERVPVTdll(self,T,D,z):
        ...
        return namedtuple('DERVPVTdlloutput',["dPdD","dPdT","d2PdD2","d2PdT2","d2PdTD","dDdP","dDdT","d2DdP2","d2DdT2","d2DdPT","dTdP","dTdD","d2TdP2","d2TdD2","d2TdPD"])(dPdD.value,dPdT.value,d2PdD2.value,d2PdT2.value,d2PdTD.value,dDdP.value,dDdT.value,d2DdP2.value,d2DdT2.value,d2DdPT.value,dTdP.value,dTdD.value,d2TdP2.value,d2TdD2.value,d2TdPD.value)
    ...
    def DHD1dll(self,T,D,z):
        ...
        return namedtuple('DHD1dlloutput',["dhdt_d","dhdt_p","dhdd_t","dhdd_p","dhdp_t","dhdp_d"])(dhdt_d.value,dhdt_p.value,dhdd_t.value,dhdd_p.value,dhdp_t.value,dhdp_d.value)
    ...
    def DHFL1dll(self,D,h,z):
        ...
        return namedtuple('DHFL1dlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def DHFLSHdll(self,D,h,z):
        ...
        return namedtuple('DHFLSHdlloutput',["T","P","Dl","Dv","x","y","q","e","s","Cv","Cp","w","ierr","herr"])(T.value,P.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def DIELECdll(self,T,D,z):
        ...
        return namedtuple('DIELECdlloutput',["de"])(de.value)
    ...
    def DLSATKdll(self,icomp,T):
        ...
        return namedtuple('DLSATKdlloutput',["D","ierr","herr"])(D.value,ierr.value,trim(herr.raw))
    ...
    def DPDD2dll(self,T,D,z):
        ...
        return namedtuple('DPDD2dlloutput',["d2PdD2"])(d2PdD2.value)
    ...
    def DPDDdll(self,T,D,z):
        ...
        return namedtuple('DPDDdlloutput',["dPdD"])(dPdD.value)
    ...
    def DPDTdll(self,T,D,z):
        ...
        return namedtuple('DPDTdlloutput',["dPdT"])(dPdT.value)
    ...
    def DPTSATKdll(self,icomp,T,kph):
        ...
        return namedtuple('DPTSATKdlloutput',["P","D","Csat","dPdT","ierr","herr"])(P.value,D.value,Csat.value,dPdT.value,ierr.value,trim(herr.raw))
    ...
    def DQFL2dll(self,D,q,z,kq):
        ...
        return namedtuple('DQFL2dlloutput',["T","P","Dl","Dv","x","y","ierr","herr"])(T.value,P.value,Dl.value,Dv.value,list(x),list(y),ierr.value,trim(herr.raw))
    ...
    def DSD1dll(self,T,D,z):
        ...
        return namedtuple('DSD1dlloutput',["dsdt_d","dsdt_p","dsdd_t","dsdd_p","dsdp_t","dsdp_d"])(dsdt_d.value,dsdt_p.value,dsdd_t.value,dsdd_p.value,dsdp_t.value,dsdp_d.value)
    ...
    def DSFL1dll(self,D,s,z):
        ...
        return namedtuple('DSFL1dlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def DSFLSHdll(self,D,s,z):
        ...
        return namedtuple('DSFLSHdlloutput',["T","P","Dl","Dv","x","y","q","e","h","Cv","Cp","w","ierr","herr"])(T.value,P.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def DVSATKdll(self,icomp,T):
        ...
        return namedtuple('DVSATKdlloutput',["D","ierr","herr"])(D.value,ierr.value,trim(herr.raw))
    ...
    def ENTHALdll(self,T,D,z):
        ...
        return namedtuple('ENTHALdlloutput',["h"])(h.value)
    ...
    def ENTROdll(self,T,D,z):
        ...
        return namedtuple('ENTROdlloutput',["s"])(s.value)
    ...
    def ESFLSHdll(self,e,s,z):
        ...
        return namedtuple('ESFLSHdlloutput',["T","P","D","Dl","Dv","x","y","q","h","Cv","Cp","w","ierr","herr"])(T.value,P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,h.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))

    def EXCESSdll(self,T,P,z,kph):
        """
        D,vE,eE,hE,sE,aE,gE,ierr,herr = EXCESSdll(T,P,z,kph)
        """
        T = ct.c_double(T)
        P = ct.c_double(P)
        z = (len(z)*ct.c_double)(*z)
        ...
        return namedtuple('EXCESSdlloutput',["D","vE","eE","hE","sE","aE","gE","ierr","herr"])(D.value,vE.value,eE.value,hE.value,sE.value,aE.value,gE.value,ierr.value,trim(herr.raw))
    ...
    def FGCTY2dll(self,T,D,z):
        ...
        return namedtuple('FGCTY2dlloutput',["f","ierr","herr"])(list(f),ierr.value,trim(herr.raw))
    ...
    def FGCTYdll(self,T,D,z):
        ...
        return namedtuple('FGCTYdlloutput',["f"])(list(f))

    def FLAGSdll(self,iFlag,jFlag):
        """
        kFlag,ierr,herr = FLAGSdll(iFlag,jFlag)
        """
        iFlag = ct.c_long(iFlag)
        ...
        self._FLAGSdll(ct.byref(iFlag),ct.byref(jFlag),ct.byref(kFlag),ct.byref(ierr),herr,255)

        return namedtuple('FLAGSdlloutput',["kFlag","ierr","herr"])(kFlag.value,ierr.value,trim(herr.raw))
    ...
    def FPVdll(self,T,D,P,z):
        ...
        return namedtuple('FPVdlloutput',["Fpvx"])(Fpvx.value)
    ...
    def FUGCOFdll(self,T,D,z):
        ...
        return namedtuple('FUGCOFdlloutput',["phi","ierr","herr"])(list(phi),ierr.value,trim(herr.raw))
    ...
    def GERG04dll(self,ncomp,iFlag):
        ...
        return namedtuple('GERG04dlloutput',["ierr","herr"])(ierr.value,trim(herr.raw))
    ...
    def GERG08dll(self,ncomp,iFlag):
        ...
        return namedtuple('GERG08dlloutput',["ierr","herr"])(ierr.value,trim(herr.raw))
    ...
    def GETFIJdll(self,hmodij):
        ...
        return namedtuple('GETFIJdlloutput',["fij","hfij","hmxrul"])(list(fij),trim(hfij.raw),trim(hmxrul.raw))
    ...
    def GETKTVdll(self,icomp,jcomp):
        ...
        return namedtuple('GETKTVdlloutput',["hmodij","fij","hfmix","hfij","hbinp","hmxrul"])(trim(hmodij.raw),list(fij),trim(hfmix.raw),trim(hfij.raw),trim(hbinp.raw),trim(hmxrul.raw))

    def GETMODdll(self,icomp):
        """
        htype,hcode,hcite = GETMODdll(icomp)
        """
        icomp = ct.c_long(icomp)
        htype = ct.create_string_buffer(3)
        ...
        return namedtuple('GETMODdlloutput',["htype","hcode","hcite"])(trim(htype.raw),trim(hcode.raw),trim(hcite.raw))
    ...
    def GIBBSdll(self,T,D,z):
        ...
        return namedtuple('GIBBSdlloutput',["ar","gr"])(ar.value,gr.value)
    ...
    def HEATFRMdll(self,T,D,z):
        ...
        return namedtuple('HEATFRMdlloutput',["hFrm","ierr","herr"])(hFrm.value,ierr.value,trim(herr.raw))
    ...
    def HEATdll(self,T,D,z):
        ...
        return namedtuple('HEATdlloutput',["hg","hn","ierr","herr"])(hg.value,hn.value,ierr.value,trim(herr.raw))
    ...
    def HMXORDERdll(self,i,j):
        ...
        return namedtuple('HMXORDERdlloutput',["hcasi","hcasj","iFlag","ierr","herr"])(trim(hcasi.raw),trim(hcasj.raw),iFlag.value,ierr.value,trim(herr.raw))
    ...
    def HSFL1dll(self,h,s,z,Dmin,Dmax):
        ...
        return namedtuple('HSFL1dlloutput',["T","D","ierr","herr"])(T.value,D.value,ierr.value,trim(herr.raw))
    ...
    def HSFLSHdll(self,h,s,z):
        ...
        return namedtuple('HSFLSHdlloutput',["T","P","D","Dl","Dv","x","y","q","e","Cv","Cp","w","ierr","herr"])(T.value,P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def IDCRVdll(self,D,z,T):
        ...
        return namedtuple('IDCRVdlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def INFOdll(self,icomp):
        ...
        return namedtuple('INFOdlloutput',["wmm","Ttrp","Tnbpt","Tc","Pc","Dc","Zc","acf","dip","Rgas"])(wmm.value,Ttrp.value,Tnbpt.value,Tc.value,Pc.value,Dc.value,Zc.value,acf.value,dip.value,Rgas.value)
    ...
    def JICRVdll(self,D,z,T):
        ...
        return namedtuple('JICRVdlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def JTCRVdll(self,D,z,T):
        ...
        return namedtuple('JTCRVdlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def LIMITKdll(self,htyp,icomp,T,D,P):
        ...
        return namedtuple('LIMITKdlloutput',["Tmin","Tmax","Dmax","Pmax","ierr","herr"])(Tmin.value,Tmax.value,Dmax.value,Pmax.value,ierr.value,trim(herr.raw))
    ...
    def LIMITSdll(self,htyp,z):
        ...
        return namedtuple('LIMITSdlloutput',["Tmin","Tmax","Dmax","Pmax"])(Tmin.value,Tmax.value,Dmax.value,Pmax.value)
    ...
    def LIMITXdll(self,htyp,T,D,P,z):
        ...
        return namedtuple('LIMITXdlloutput',["Tmin","Tmax","Dmax","Pmax","ierr","herr"])(Tmin.value,Tmax.value,Dmax.value,Pmax.value,ierr.value,trim(herr.raw))
    ...
    def LIQSPNDLdll(self,T,z):
        ...
        return namedtuple('LIQSPNDLdlloutput',["D","ierr","herr"])(D.value,ierr.value,trim(herr.raw))
    ...
    def MASSFLUXdll(self,Tm,P,z,beta,rf):
        ...
        return namedtuple('MASSFLUXdlloutput',["fluxm","Cs","T0","P0","xMach","u","Ts","Ps","ierr","herr"])(fluxm.value,Cs.value,T0.value,P0.value,xMach.value,u.value,Ts.value,Ps.value,ierr.value,trim(herr.raw))
    ...
    def MAXPdll(self,z):
        ...
        return namedtuple('MAXPdlloutput',["Tm","Pm","Dm","ierr","herr"])(Tm.value,Pm.value,Dm.value,ierr.value,trim(herr.raw))
    ...
    def MAXTdll(self,z):
        ...
        return namedtuple('MAXTdlloutput',["Tm","Pm","Dm","ierr","herr"])(Tm.value,Pm.value,Dm.value,ierr.value,trim(herr.raw))
    ...
    def MELTPdll(self,P,z):
        ...
        return namedtuple('MELTPdlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def MELTTdll(self,T,z):
        ...
        return namedtuple('MELTTdlloutput',["P","ierr","herr"])(P.value,ierr.value,trim(herr.raw))
    ...
    def MLTH2Odll(self,T):
        ...
        return namedtuple('MLTH2Odlloutput',["P1","P2"])(P1.value,P2.value)
    ...
    def NAMEdll(self,icomp):
        ...
        return namedtuple('NAMEdlloutput',["hnam","hn80","hcasn"])(trim(hnam.raw),trim(hn80.raw),trim(hcasn.raw))
    ...
    def PASSCMNdll(self,hvr,iset,icomp,jcomp,hstr,ilng,dbl,arr):
        ...
        return namedtuple('PASSCMNdlloutput',["hstr","ilng","dbl","arr","ierr","herr"])(trim(hstr.raw),ilng.value,dbl.value,list(arr),ierr.value,trim(herr.raw))
    ...
    def PDFL1dll(self,P,D,z):
        ...
        return namedtuple('PDFL1dlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def PDFLSHdll(self,P,D,z):
        ...
        return namedtuple('PDFLSHdlloutput',["T","Dl","Dv","x","y","q","e","h","s","Cv","Cp","w","ierr","herr"])(T.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def PEFL1dll(self,P,e,z,kph):
        ...
        return namedtuple('PEFL1dlloutput',["T","D","ierr","herr"])(T.value,D.value,ierr.value,trim(herr.raw))
    ...
    def PEFLSHdll(self,P,e,z):
        ...
        return namedtuple('PEFLSHdlloutput',["T","D","Dl","Dv","x","y","q","h","s","Cv","Cp","w","ierr","herr"])(T.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def PHFL1dll(self,P,h,z,kph):
        ...
        return namedtuple('PHFL1dlloutput',["T","D","ierr","herr"])(T.value,D.value,ierr.value,trim(herr.raw))
    ...
    def PHFLSHdll(self,P,h,z):
        ...
        return namedtuple('PHFLSHdlloutput',["T","D","Dl","Dv","x","y","q","e","s","Cv","Cp","w","ierr","herr"])(T.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def PHI0dll(self,itau,idel,T,D,z):
        ...
        return namedtuple('PHI0dlloutput',["phi00"])(phi00.value)
    ...
    def PHIDERVdll(self,iderv,T,D,z):
        ...
        return namedtuple('PHIDERVdlloutput',["dadn","dnadn","ierr","herr"])(list(dadn),list(dnadn),ierr.value,trim(herr.raw))
    ...
    def PHIXdll(self,itau,idel,tau,delta,z):
        ...
        return namedtuple('PHIXdlloutput',["phixx"])(phixx.value)
    ...
    def PQFLSHdll(self,P,q,z,kq):
        ...
        return namedtuple('PQFLSHdlloutput',["T","D","Dl","Dv","x","y","e","h","s","Cv","Cp","w","ierr","herr"])(T.value,D.value,Dl.value,Dv.value,list(x),list(y),e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def PRESSdll(self,T,D,z):
        ...
        return namedtuple('PRESSdlloutput',["P"])(P.value)
    ...
    def PSATKdll(self,icomp,T):
        ...
        return namedtuple('PSATKdlloutput',["P","ierr","herr"])(P.value,ierr.value,trim(herr.raw))
    ...
    def PSFL1dll(self,P,s,z,kph):
        ...
        return namedtuple('PSFL1dlloutput',["T","D","ierr","herr"])(T.value,D.value,ierr.value,trim(herr.raw))
    ...
    def PSFLSHdll(self,P,s,z):
        ...
        return namedtuple('PSFLSHdlloutput',["T","D","Dl","Dv","x","y","q","e","h","Cv","Cp","w","ierr","herr"])(T.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def QMASSdll(self,qmol,xl,xv):
        ...
        return namedtuple('QMASSdlloutput',["qkg","xlkg","xvkg","wliq","wvap","ierr","herr"])(qkg.value,list(xlkg),list(xvkg),wliq.value,wvap.value,ierr.value,trim(herr.raw))
    ...
    def QMOLEdll(self,qkg,xlkg,xvkg):
        ...
        return namedtuple('QMOLEdlloutput',["qmol","xl","xv","wliq","wvap","ierr","herr"])(qmol.value,list(xl),list(xv),wliq.value,wvap.value,ierr.value,trim(herr.raw))
    ...
    def RDXHMXdll(self,ix,icmp,icmp2,z):
        ...
        return namedtuple('RDXHMXdlloutput',["Tred","Dred","ierr","herr"])(Tred.value,Dred.value,ierr.value,trim(herr.raw))
    ...
    def REDXdll(self,z):
        ...
        return namedtuple('REDXdlloutput',["Tred","Dred"])(Tred.value,Dred.value)
    ...
    def RESIDUALdll(self,T,D,z):
        ...
        return namedtuple('RESIDUALdlloutput',["Pr","er","hr","sr","Cvr","Cpr","ar","gr"])(Pr.value,er.value,hr.value,sr.value,Cvr.value,Cpr.value,ar.value,gr.value)
    ...
    def RIEMdll(self,T,D,z):
        ...
        return namedtuple('RIEMdlloutput',["riemc"])(riemc.value)
    ...
    def RMIX2dll(self,z):
        ...
        return namedtuple('RMIX2dlloutput',["Rgas"])(Rgas.value)
    ...
    def RPVersion(self,):
        ...
        return namedtuple('RPVersionoutput',["hv"])(trim(hv.raw))
    ...
    def SATDdll(self,D,z,kph):
        ...
        return namedtuple('SATDdlloutput',["kr","T","P","Dl","Dv","x","y","ierr","herr"])(kr.value,T.value,P.value,Dl.value,Dv.value,list(x),list(y),ierr.value,trim(herr.raw))
    ...
    def SATEdll(self,e,z,kph):
        ...
        return namedtuple('SATEdlloutput',["nroot","k1","T1","P1","D1","k2","T2","P2","D2","ierr","herr"])(nroot.value,k1.value,T1.value,P1.value,D1.value,k2.value,T2.value,P2.value,D2.value,ierr.value,trim(herr.raw))
    ...
    def SATGUESSdll(self,kph,iprop,x,T,P,D,h,s,Dy,y):
        ...
        return namedtuple('SATGUESSdlloutput',["T","P","D","h","s","Dy","y","ierr","herr"])(T.value,P.value,D.value,h.value,s.value,Dy.value,list(y),ierr.value,trim(herr.raw))
    ...
    def SATGVdll(self,T,P,z,vf,b,ipv,ityp,isp,Dx,Dy,x,y):
        ...
        return namedtuple('SATGVdlloutput',["T","P","Dx","Dy","x","y","ierr","herr"])(T.value,P.value,Dx.value,Dy.value,list(x),list(y),ierr.value,trim(herr.raw))
    ...
    def SATHdll(self,h,z,kph):
        ...
        return namedtuple('SATHdlloutput',["nroot","k1","T1","P1","D1","k2","T2","P2","D2","ierr","herr"])(nroot.value,k1.value,T1.value,P1.value,D1.value,k2.value,T2.value,P2.value,D2.value,ierr.value,trim(herr.raw))

    def SATPESTdll(self,P,z,kph,T,x2):
        """
        T,x2,ierr,herr = SATPESTdll(P,z,kph,T,x2)
        """
        P = ct.c_double(P)
        z = (len(z)*ct.c_double)(*z)
        kph = ct.c_long(kph)
        T = ct.c_double(T)
        x2 = (len(x2)*ct.c_double)(*x2)
        ierr = ct.c_long()
        herr = ct.create_string_buffer(255)
        ...
        return namedtuple('SATPESTdlloutput',["T","x2","ierr","herr"])(T.value,list(x2),ierr.value,trim(herr.raw))
    ...
    def SATPdll(self,P,z,kph):
        ...
        return namedtuple('SATPdlloutput',["T","Dl","Dv","x","y","ierr","herr"])(T.value,Dl.value,Dv.value,list(x),list(y),ierr.value,trim(herr.raw))
    ...
    def SATSPLNdll(self,z):
        ...
        return namedtuple('SATSPLNdlloutput',["ierr","herr"])(ierr.value,trim(herr.raw))
    ...
    def SATSdll(self,s,z,kph):
        ...
        return namedtuple('SATSdlloutput',["nroot","k1","T1","P1","D1","k2","T2","P2","D2","k3","T3","P3","D3","ierr","herr"])(nroot.value,k1.value,T1.value,P1.value,D1.value,k2.value,T2.value,P2.value,D2.value,k3.value,T3.value,P3.value,D3.value,ierr.value,trim(herr.raw))

    def SATTESTdll(self,T,z,kph,P,x2):
        """
        P,x2,ierr,herr = SATTESTdll(T,z,kph,P,x2)
        """
        T = ct.c_double(T)
        z = (len(z)*ct.c_double)(*z)
        kph = ct.c_long(kph)
        ...
        return namedtuple('SATTESTdlloutput',["P","x2","ierr","herr"])(P.value,list(x2),ierr.value,trim(herr.raw))

    def SATTPdll(self,T,P,z,iFlsh,iGuess):
        """
        D,Dl,Dv,x,y,q,ierr,herr = SATTPdll(T,P,z,iFlsh,iGuess)
        """
        T = ct.c_double(T)
        P = ct.c_double(P)
        z = (len(z)*ct.c_double)(*z)
        ...
        return namedtuple('SATTPdlloutput',["D","Dl","Dv","x","y","q","ierr","herr"])(D.value,Dl.value,Dv.value,list(x),list(y),q.value,ierr.value,trim(herr.raw))
    ...
    def SATTdll(self,T,z,kph):
        ...
        return namedtuple('SATTdlloutput',["P","Dl","Dv","x","y","ierr","herr"])(P.value,Dl.value,Dv.value,list(x),list(y),ierr.value,trim(herr.raw))
    ...
    def SETAGAdll(self,):
        ...
        return namedtuple('SETAGAdlloutput',["ierr","herr"])(ierr.value,trim(herr.raw))
    ...
    def SETKTVdll(self,icomp,jcomp,hmodij,fij,hfmix):
        ...
        return namedtuple('SETKTVdlloutput',["ierr","herr"])(ierr.value,trim(herr.raw))

    def SETMIXdll(self,hmxnme,hfmix,hrf):
        """
        ncc,hfiles,z,ierr,herr = SETMIXdll(hmxnme,hfmix,hrf)
        """
        hmxnme = ct.create_string_buffer(hmxnme.encode('utf-8'),255)
        hfmix = ct.create_string_buffer(hfmix.encode('utf-8'),255)
        ...
        self._SETMIXdll(hmxnme,hfmix,hrf,ct.byref(ncc),hfiles,z,ct.byref(ierr),herr,255,255,3,10000,255)

        return namedtuple('SETMIXdlloutput',["ncc","hfiles","z","ierr","herr"])(ncc.value,trim(hfiles.raw),list(z),ierr.value,trim(herr.raw))

    def SETMODdll(self,ncomp):
        """
        htype,hmix,hcomp,ierr,herr = SETMODdll(ncomp)
        """
        ncomp = ct.c_long(ncomp)
        htype = ct.create_string_buffer(3)
        hmix = ct.create_string_buffer(3)
        hcomp = ct.create_string_buffer(60)
        ierr = ct.c_long()
        herr = ct.create_string_buffer(255)
        ...
        return namedtuple('SETMODdlloutput',["htype","hmix","hcomp","ierr","herr"])(trim(htype.raw),trim(hmix.raw),trim(hcomp.raw),ierr.value,trim(herr.raw))
    ...
    def SETREFdll(self,hrf,ixflag,x0,h0,s0,T0,P0):
        ...
        return namedtuple('SETREFdlloutput',["ierr","herr"])(ierr.value,trim(herr.raw))
    ...
    def SETUPdll(self,ncomp,hfiles,hfmix,hrf):
        ...
        return namedtuple('SETUPdlloutput',["ierr","herr"])(ierr.value,trim(herr.raw))
    ...
    def SPLNROOTdll(self,isp,iderv,f):
        ...
        return namedtuple('SPLNROOTdlloutput',["a","ierr","herr"])(a.value,ierr.value,trim(herr.raw))
    ...
    def SPLNVALdll(self,isp,iderv,a):
        ...
        return namedtuple('SPLNVALdlloutput',["f","ierr","herr"])(f.value,ierr.value,trim(herr.raw))
    ...
    def SUBLPdll(self,P,z):
        ...
        return namedtuple('SUBLPdlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def SUBLTdll(self,T,z):
        ...
        return namedtuple('SUBLTdlloutput',["P","ierr","herr"])(P.value,ierr.value,trim(herr.raw))
    ...
    def SURFTdll(self,T,Dl,z):
        ...
        return namedtuple('SURFTdlloutput',["sigma","ierr","herr"])(sigma.value,ierr.value,trim(herr.raw))
    ...
    def SURTENdll(self,T,Dl,Dv,x,y):
        ...
        return namedtuple('SURTENdlloutput',["sigma","ierr","herr"])(sigma.value,ierr.value,trim(herr.raw))
    ...
    def TDFLSHdll(self,T,D,z):
        ...
        return namedtuple('TDFLSHdlloutput',["P","Dl","Dv","x","y","q","e","h","s","Cv","Cp","w","ierr","herr"])(P.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def TEFL1dll(self,T,e,z,Dmin,Dmax):
        ...
        return namedtuple('TEFL1dlloutput',["D","ierr","herr"])(D.value,ierr.value,trim(herr.raw))
    ...
    def TEFLSHdll(self,T,e,z,kr):
        ...
        return namedtuple('TEFLSHdlloutput',["P","D","Dl","Dv","x","y","q","h","s","Cv","Cp","w","ierr","herr"])(P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def THERM0dll(self,T,D,z):
        ...
        return namedtuple('THERM0dlloutput',["P0","e0","h0","s0","Cv0","Cp00","w0","a0","g0"])(P0.value,e0.value,h0.value,s0.value,Cv0.value,Cp00.value,w0.value,a0.value,g0.value)
    ...
    def THERM2dll(self,T,D,z):
        ...
        return namedtuple('THERM2dlloutput',["P","e","h","s","Cv","Cp","w","zz","hjt","a","g","xkappa","beta","dPdD","d2PdD2","dPdT","dDdT","dDdP","d2PdT2","d2PdTD","spare3","spare4"])(P.value,e.value,h.value,s.value,Cv.value,Cp.value,w.value,zz.value,hjt.value,a.value,g.value,xkappa.value,beta.value,dPdD.value,d2PdD2.value,dPdT.value,dDdT.value,dDdP.value,d2PdT2.value,d2PdTD.value,spare3.value,spare4.value)
    ...
    def THERM3dll(self,T,D,z):
        ...
        return namedtuple('THERM3dlloutput',["xkappa","beta","xisenk","xkt","betas","bs","xkkt","thrott","pi","spht"])(xkappa.value,beta.value,xisenk.value,xkt.value,betas.value,bs.value,xkkt.value,thrott.value,pi.value,spht.value)
    ...
    def THERMdll(self,T,D,z):
        ...
        return namedtuple('THERMdlloutput',["P","e","h","s","Cv","Cp","w","hjt"])(P.value,e.value,h.value,s.value,Cv.value,Cp.value,w.value,hjt.value)
    ...
    def THFL1dll(self,T,h,z,Dmin,Dmax):
        ...
        return namedtuple('THFL1dlloutput',["D","ierr","herr"])(D.value,ierr.value,trim(herr.raw))
    ...
    def THFLSHdll(self,T,h,z,kr):
        ...
        return namedtuple('THFLSHdlloutput',["P","D","Dl","Dv","x","y","q","e","s","Cv","Cp","w","ierr","herr"])(P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def TPFL2dll(self,T,P,z):
        ...
        return namedtuple('TPFL2dlloutput',["Dl","Dv","x","y","q","ierr","herr"])(Dl.value,Dv.value,list(x),list(y),q.value,ierr.value,trim(herr.raw))
    ...
    def TPFLSHdll(self,T,P,z):
        ...
        return namedtuple('TPFLSHdlloutput',["D","Dl","Dv","x","y","q","e","h","s","Cv","Cp","w","ierr","herr"])(D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def TPRHOPRdll(self,T,P,z):
        ...
        return namedtuple('TPRHOPRdlloutput',["D1","D2"])(D1.value,D2.value)
    ...
    def TPRHOdll(self,T,P,z,kph,kguess,D):
        ...
        return namedtuple('TPRHOdlloutput',["D","ierr","herr"])(D.value,ierr.value,trim(herr.raw))
    ...
    def TQFLSHdll(self,T,q,z,kq):
        ...
        return namedtuple('TQFLSHdlloutput',["P","D","Dl","Dv","x","y","e","h","s","Cv","Cp","w","ierr","herr"])(P.value,D.value,Dl.value,Dv.value,list(x),list(y),e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def TRNPRPdll(self,T,D,z):
        ...
        return namedtuple('TRNPRPdlloutput',["eta","tcx","ierr","herr"])(eta.value,tcx.value,ierr.value,trim(herr.raw))
    ...
    def TSATDdll(self,D,z):
        ...
        return namedtuple('TSATDdlloutput',["T","ierr","herr"])(T.value,ierr.value,trim(herr.raw))
    ...
    def TSFL1dll(self,T,s,z,Dmin,Dmax):
        ...
        return namedtuple('TSFL1dlloutput',["D","ierr","herr"])(D.value,ierr.value,trim(herr.raw))
    ...
    def TSFLSHdll(self,T,s,z,kr):
        ...
        return namedtuple('TSFLSHdlloutput',["P","D","Dl","Dv","x","y","q","e","h","Cv","Cp","w","ierr","herr"])(P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def VAPSPNDLdll(self,T,z):
        ...
        return namedtuple('VAPSPNDLdlloutput',["D","ierr","herr"])(D.value,ierr.value,trim(herr.raw))
    ...
    def VIRBAdll(self,T,z):
        ...
        return namedtuple('VIRBAdlloutput',["Ba"])(Ba.value)
    ...
    def VIRBdll(self,T,z):
        ...
        return namedtuple('VIRBdlloutput',["B"])(B.value)
    ...
    def VIRCAdll(self,T,z):
        ...
        return namedtuple('VIRCAdlloutput',["Ca"])(Ca.value)
    ...
    def VIRCdll(self,T,z):
        ...
        return namedtuple('VIRCdlloutput',["C"])(C.value)
    ...
    def WMOLIdll(self,icomp):
        ...
        return namedtuple('WMOLIdlloutput',["wmm"])(wmm.value)
    ...
    def WMOLdll(self,z):
        ...
        return namedtuple('WMOLdlloutput',["wmm"])(wmm.value)
    ...
    def XMASSdll(self,xmol):
        ...
        return namedtuple('XMASSdlloutput',["xkg","wmix"])(list(xkg),wmix.value)
    ...
    def XMOLEdll(self,xkg):
        ...
        return namedtuple('XMOLEdlloutput',["xmol","wmix"])(list(xmol),wmix.value)
