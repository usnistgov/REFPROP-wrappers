...
on 16 May 2018 15:20:12.  This interface was written by Ian Bell. 
...
class REFPROPInstance(object):
    ...
    def REFPROP2dll(self,hFld,hIn,hOut,iUnits,iFlag,a,b,z):
        ...
        return self._REFPROP2dlloutput_tuple(list(z),list(Output),q.value,ierr.value,trim(herr.raw))
